                    ...
                    <form action="{{ route('admin.sights.update',$sight)}}" method="post" enctype="multipart/form-data">
                        ...
                        @method('put')
                          ...
                          <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="title" value="{{ $sight->title }}" name="title"  required>
                          </div>
                           <div class="row mb-3">
                              <div class="col">
                           ...
                           <div class=" row mb-3">
                            <div class="col">
                                ...
                                <input type="text" class="form-control"  value="{{ $sight->latitud }}" name="latitud"  required>
                            </div>
                            <div class="col">
                                
                                <input type="text" class="form-control"  value="{{ $sight->longitud }}" name="longitud"  required>
                            </div>
                          ...
                          <div class="row mb-3">
                            <div class="col">
                                ...
                                <input type="text" class="form-control"  value="{{ $sight->caption }}" name="caption"  required>
                            </div>
                            <div class="col">
                                
                                <input type="date" class="form-control"  value="{{ $sight->date }}" name="date" required>
                            </div>
                            <div class="col">
                                
                                <input type="number" class="form-control"  value="{{ $sight->zoom }}" name="zoom" >
                            </div>
                          
                          </div>
                          <div class="row mb-3">
                            <div class="col-md-4 mx-auto">
                                <img  id="preview-image-before-upload" class="img-fluid d-block mx-auto" src="{{ asset('storage/sights/'.$sight->image)}}" alt="">
                            </div>
                        </div>
                          <div class="mb-3">
                          ...
                          <div class="mb-3">
                            ...
                            <textarea class="form-control" id="extract" rows="3" required name="extract">
                                {!! $sight->extract !!}
                            </textarea>
                          </div>
                          <div class="mb-3">
